...
import conf
name1 = 'cdr-frozen-upwind-sparse0.005-noise0.001'
name2 = 'cdr-2-upwind-sparse0.005-noise0.001'
...
for i in range(len(showblock)):
    ...
    ax.flatten()[j].set_ylim(1e-3,0.8)
    ax.flatten()[j].set_xticks([1,100,200])
